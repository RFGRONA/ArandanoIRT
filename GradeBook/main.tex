...
\include{capitulo_ia}              % Capítulo VI: Integración de la Inteligencia Artificial en la Detección Temprana de Botrytis Cinerea
\include{capitulo_conclusiones}     % Capítulo VII: Resultados Integrados y Conclusiones Globales
