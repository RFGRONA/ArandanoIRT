...
\AtBeginDocument{
  ...
  %\renewcommand{\BOthersStar}[1]{et al.\hbox{}}
...
\hypersetup{
    ...
    urlcolor=black      % Color para URLs externas
}
...
\begin{flushleft}
    \textsc{Juan Esteban Fuentes Rojas}
\end{flushleft}
\vspace{1cm} 

\begin{center}
\textit{A mi madre Sandra, por su amor incondicional, por acompañarme en cada paso y ser mi mayor apoyo durante este largo año de trabajo.}  

\textit{Su fortaleza y confianza fueron el impulso que me permitió seguir adelante.}  

\vspace{0.8cm}

\textit{A mis hermanos, Sebastian, Thatiana e Isabella por sus comentarios, sugerencias y palabras de ánimo que siempre aportaron a la construcción de este proyecto.}

\vspace{0.8cm}

\textit{A mis amigos de la universidad, Gabriel Martínez, Felipe Valcarcel, Duvan Matallana, Laura Latorre y Santiago Sierra, por estar presentes cuando más los necesité, por su ayuda sincera y por compartir conmigo los momentos más difíciles y también los más felices de este proceso.}  

\vspace{0.8cm}

\textit{Y, con todo mi corazón, a mi pareja Estefania, mi querida Nia.}  

\textit{Por su amor, comprensión y paciencia infinita; por acompañarme en cada desafío, en cada desvelo, y recordarme siempre por qué valía la pena continuar.}
\end{center}
\vspace*{\fill}
...
\begin{flushleft}
    \textsc{Gabriel Esteban Martinez Roldan}
\end{flushleft}
\vspace{1cm}

\begin{center}
\textit{Dedico este trabajo:}

\vspace{0.5cm}

\textit{Primeramente a Dios, fuente de fortaleza, sabiduría e inspiración,}  
\textit{sin cuya guía y amor no habría sido posible llegar hasta aquí.}

\vspace{0.5cm}

\textit{A mi familia, pilar fundamental en mi vida,}  
\textit{en especial a mi madre, Nancy Roldan,}  
\textit{por su amor y apoyo invaluable en cada paso.}

\vspace{0.5cm}

\textit{A mis amigos Ivone Lopez y Fredy Zarate,}
\textit{también a Riveros, Felipe, Mayatana, Laura y Sierra,}
\textit{por su compañía y palabras de aliento.}
\textit{Y como no, a mi hermano de otra madre, Juan Fuentes.}

\vspace{0.5cm}

\textit{A mi pareja, Angie Cardenas,}  
\textit{por su presencia constante, paciencia y por ser}  
\textit{un apoyo incondicional en todo momento.}
\end{center}
\vspace*{\fill}
...
Expresamos nuestro más sincero agradecimiento al semillero de investigación LINUDECX por el espacio de aprendizaje y colaboración brindado.

Agradecemos profundamente a nuestra directora de proyecto, Ing. Gina Valenzuela, por su constante guía, paciencia e invaluable apoyo durante todas las etapas de esta investigación. Su orientación fue fundamental para la culminación de este trabajo.

Asimismo, agradecemos a los jurados, Ing. Alexander Espinosa, y en espeical al Ing. Jaime Andrade, por su tiempo y valiosa retroalimentación, cuyas observaciones permitieron enriquecer significativamente este trabajo.

Un agradecimiento especial a Alvaro Bolivar, David Bolivar y Sebastian Martinez, por su constante apoyo y facilitar recursos que contribuyeron al desarrollo de esta investigación.

Finalmente, agradecemos de corazón a nuestras mascotas, familias y parejas por su amor, comprensión y apoyo incondicional en todo momento. 

Gracias a Dios por la fortaleza y las oportunidades brindadas.
...
La agricultura contemporánea enfrenta el desafío dual de incrementar la producción de alimentos para una población creciente y, simultáneamente, adaptarse a los efectos del cambio climático, que intensifican la presión sobre recursos vitales como el agua \shortcite{Laveglia2024}. La gestión hídrica eficiente se ha convertido, por tanto, en una prioridad global, impulsando la adopción de prácticas agrícolas más sostenibles y tecnificadas. En este contexto, la agricultura de precisión emerge como una estrategia fundamental, empleando tecnologías para medir y responder a la variabilidad espacial y temporal de los cultivos, optimizando así el uso de insumos y mejorando la toma de decisiones agronómicas \shortcite{Dong2024, Vargas2021}.

Entre los cultivos de alto valor que demandan una gestión hídrica cuidadosa se encuentra el arándano (\textit{Vaccinium corymbosum} L.), cuya popularidad ha impulsado su expansión en diversas regiones, incluyendo el altiplano cundiboyacense colombiano \shortcite{Aimeth2018}. La variedad Biloxi, adaptada a climas con bajos requerimientos de frío, es particularmente relevante en esta zona \shortcite{QuintanaReina2020, Balbontin2023}. Sin embargo, el arándano posee un sistema radicular superficial y poco eficiente, lo que lo hace vulnerable al estrés hídrico, tanto por déficit como por exceso, comprometiendo significativamente el crecimiento de la planta, el calibre de los frutos y el rendimiento final de la cosecha \shortcite{Morales2017, INIA2017, Almutairi2021, Salgado2018}. La detección temprana y precisa del estrés hídrico es, por lo tanto, crucial para optimizar el riego y asegurar la sostenibilidad económica del cultivo \shortcite{Rinza2021}.

La termografía infrarroja (IRT) se ha consolidado como una técnica no invasiva y eficaz para este propósito \shortcite{GarciaTejero2015, ErazoAux2022}. Se basa en el principio fisiológico de que las plantas, al experimentar déficit hídrico, cierran sus estomas para conservar agua, reduciendo la transpiración y provocando un aumento medible en la temperatura de la superficie foliar \shortcite{Jones2004, Pineda2021, Cho2024, Pradawet2023}. Índices derivados de la IRT, como el Índice de Estrés Hídrico del Cultivo (CWSI), permiten cuantificar este nivel de estrés \shortcite{Idso1981, Quezada2020}. No obstante, la aplicación generalizada de la IRT en la agricultura ha estado generalmente limitada por el elevado costo de las cámaras termográficas comerciales, creando una brecha tecnológica significativa, especialmente para pequeños y medianos productores \shortcite{Dong2024, Yun2023}.

Avances recientes en la tecnología de sensores de matrices térmicas de bajo costo como el MLX90640\footnote{\url{https://www.melexis.com/en/documents/documentation/datasheets/datasheet-mlx90640}}, han abierto nuevas posibilidades para desarrollar herramientas de monitoreo más asequibles \shortcite{Dong2024}. Sin embargo, la fiabilidad de estos componentes de bajo costo en aplicaciones agrícolas exigentes requiere una validación metrológica antes de su implementación práctica \shortcite{Acorsi2020, Jiao2022, Yun2023}. Factores como la deriva térmica y la sensibilidad a condiciones ambientales pueden impactar su precisión y estabilidad temporal, requiriendo una caracterización bajo escenarios operativos reales.

Este trabajo aborda precisamente esta problemática, presentando el diseño, desarrollo, validación y prueba de concepto de un \textbf{sistema integral de bajo costo para la detección del estrés hídrico en arándano Biloxi mediante termografía infrarroja}. El sistema combina hardware asequible con software embebido y una aplicación web para la adquisición, procesamiento (cálculo de $\Delta T$ y CWSI) y visualización de datos.
